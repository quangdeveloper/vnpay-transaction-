                ...
                <div className="d-flex flex-column flex-root">
                    ...
                    <span className="input-group-text">
                      <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25">
                        <g id="Group_319" data-name="Group 319" transform="translate(-914.5 -354.5)">
                          <rect id="Frame" width="24" height="24" transform="translate(915 355)" fill="#90a4ae"
                    ...
                    <span className="input-group-text">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <g id="Group_320" data-name="Group 320" transform="translate(-915 -425)">
                                ...
                                <div className="login-form login-signup">
                                    ...
                                    <form className="form" noValidate="novalidate" id="kt_login_signup_form">
                                        ...
                                        <div className="pb-13 pt-lg-0 pt-5 text-center">
                                            ...
                                            <p className="text-muted">Thông tin mật khẩu mới đã được gửi vào hòm thư
                                                đăng ký.<br/>Vui lòng kiểm tra email và làm theo hướng dẫn.</p>
                                        </div>
                                        {/*<!--end::Title--*/}
                                        {/*<!--begin::Form group--*/}
                                        <div className="form-group d-flex flex-wrap pb-lg-0 pb-3">
                                            <button type="button" id="BackToLogin"
                                                    className="btn btn-block btn-primary font-size-h6 px-8 py-4 my-3 mr-4">Quay
                                                lại đăng nhập
                                            </button>
                                        </div>
                                        {/*<!--end::Form group--*/}
                                ...
                                <div className="login-form login-forgot">
                                    ...
                                    <form className="form" noValidate="novalidate" id="kt_login_forgot_form">
                                        ...
                                        <div className="pb-13 pt-lg-0 pt-5 text-center">
                                            ...
                                            <p className="text-muted"><span className="row_1">Vui lòng nhập email đăng ký tài khoản vào ô dưới để</span>
                    ...
                    <span className="input-group-text">
                      <svg xmlns="http://www.w3.org/2000/svg"  xmlnsXlink="http://www.w3.org/1999/xlink" width="24" height="24" viewBox="0 0 24 24">
                          ...
                          <clipPath id="clipPath">
                            <rect id="Rectangle_119" data-name="Rectangle 119" width="18" height="13.701"
                                  transform="translate(0 0)" fill="#90a4ae"/>
                          </clipPath>
                        </defs>
                        <g id="Group_321" data-name="Group 321" transform="translate(-915 -437)">
                          <rect id="Rectangle_120" data-name="Rectangle 120" width="24" height="24"
                                transform="translate(915 437)" fill="#fff" opacity="0"/>
                          <g id="Group_186" data-name="Group 186" transform="translate(918 442)"
                            ...
                            <div className="text-center py-7 py-lg-0">
                                <a className="btn btn-hover-bg-light" href="guide.html"><span
